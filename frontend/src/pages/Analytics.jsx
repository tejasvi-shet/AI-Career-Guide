...
function Analytics() {
  ...
  const roleData = Object.keys(roleCount)
      ...
      <div className="flex-1 p-8">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-slate-900 p-6 rounded-xl">
            <h2 className="text-2xl mb-4">Match Score Trend</h2>
          ...
          <div className="bg-slate-900 p-6 rounded-xl">
            <h2 className="text-2xl mb-4">Role Distribution</h2>
        ...
        <div className="bg-slate-900 p-6 rounded-xl mb-8">
          <h2 className="text-2xl mb-4">Top Skills</h2>
        ...
        <div className="bg-slate-900 p-6 rounded-xl">
          <h2 className="text-2xl mb-6">Recent Analyses</h2>
