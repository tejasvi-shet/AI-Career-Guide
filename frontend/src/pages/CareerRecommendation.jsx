  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const careerResponse = await fetch(
        "https://ai-career-guide-backend-weg0.onrender.com/career-recommendation",
        {
          method: "POST",
          headers: {
      ...
      setRecommendations(careerData.recommendations || "");
      await fetch(
        "https://ai-career-guide-backend-weg0.onrender.com/save-history",
        {
          ...
          body: JSON.stringify({
            ...
            career_recommendation: careerData.recommendations,
          }),
        },
      );
  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-white">
      ...
      <div className="flex-1 p-8">
        <h1 className="text-4xl font-bold mb-8">AI Career Recommendation</h1>
        ...
        <div className="bg-slate-900 p-6 rounded-xl">
          ...
          {recommendations ? (
            ...
            <p className="text-gray-400">
              Upload a resume to receive AI-powered career recommendations.
            </p>
          )}
        </div>
      </div>
