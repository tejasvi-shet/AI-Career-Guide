  ...
  const generateRoadmap = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://ai-career-guide-backend-weg0.onrender.com/roadmap",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-white">
      ...
      <div className="flex-1 p-8">
        <h1 className="text-4xl font-bold mb-8">Learning Roadmap</h1>

        {/* Role Selection */}
        <div className="bg-slate-900 p-6 rounded-xl mb-8">
          <h2 className="text-2xl font-semibold mb-4">Select Career Goal</h2>
        ...
        <div className="bg-slate-900 p-6 rounded-xl">
          <h2 className="text-2xl font-semibold mb-6">Learning Journey</h2>
